...
Drive 0-2 自动寻找参考输入区间两端，反向回到 (entry+exit)/2 并置零；单轴第二边沿最大搜索距离 100000 counts，穿越/回中点超时 120.0 s。
...
[INFO] [launch]: All log files can be found below /root/.ros/log/2026-07-27-16-35-37-837970-irs-rascl06-222
[INFO] [launch]: Default logging verbosity is set to INFO
[INFO] [rascl_faulhaber_bridge.py-1]: process started with pid [225]
[rascl_faulhaber_bridge.py-1] [INFO] [1785170138.145784401] [rascl_faulhaber_bridge]: Connecting EtherCAT on enx3c18a0256deb; control_mode=homing_csp
[rascl_faulhaber_bridge.py-1] [INFO] [1785170138.146195262] [rascl_faulhaber_bridge]: CSP stall diagnostics: error>=25000 counts, progress<100 counts for 500 ms
[rascl_faulhaber_bridge.py-1] [INFO] [1785170138.146585634] [rascl_faulhaber_bridge]: CSP handoff will clear and verify volatile lower/upper limit-input mappings 0x2310:01/:02; Homing reference, input polarity and 0x607B/0x607D remain unchanged
[rascl_faulhaber_bridge.py-1] [INFO] [1785170138.146980335] [rascl_faulhaber_bridge]: Drive 0-2 Homing uses the centre of the reference-input interval: find the first edge with the configured native method, traverse the active interval at Homing search speed, return to (entry+exit)/2, then set that midpoint to zero with Method 37
[rascl_faulhaber_bridge.py-1] [INFO] [1785170138.147397651] [rascl_faulhaber_bridge]: Drive 3 skips sensor Homing; after Drives 0-2 Home it will move +50000 counts and use Homing Method 37 to set that position to 0
...
[rascl_faulhaber_bridge.py-1] [WARN] [1785170138.200326433] [rascl_faulhaber_bridge]: Drive 2 CSP following-error monitor changed for this session only: 0x6065 16384 -> 25000 counts; 0x6066 48 -> 250 ms. 0x607B/0x607D were read only, not modified. Drive 2 protection: 0x607B position_range=[-2147483648, 2147483647], 0x607D software_limit=[-802816, 802816], 0x6065 following_window=25000 counts, 0x6066 following_timeout=250 ms
[rascl_faulhaber_bridge.py-1] [INFO] [1785170138.205016573] [rascl_faulhaber_bridge]: TCP bridge listening on 127.0.0.1:15001
...
[rascl_faulhaber_bridge.py-1] [Drive 0] first Homing edge=0 counts; post-edge stop=-831 counts
[rascl_faulhaber_bridge.py-1] [Drive 0] mode requested=1, display=1
[rascl_faulhaber_bridge.py-1] [Drive 0] Controlword <- 0x000F
...
[rascl_faulhaber_bridge.py-1] [Drive 0] Controlword <- 0x000F
[rascl_faulhaber_bridge.py-1] [Drive 0] mode requested=1, display=1
[rascl_faulhaber_bridge.py-1] [WARN] [1785170155.238463610] [rascl_faulhaber_bridge]: HOMING_INTERVAL drive=0 entry=0 exit=-59657 width=59657 midpoint=-29829 reached=-29827 zero=0
...
[rascl_faulhaber_bridge.py-1] [Drive 1] first Homing edge=0 counts; post-edge stop=-784 counts
[rascl_faulhaber_bridge.py-1] [Drive 1] mode requested=1, display=1
[rascl_faulhaber_bridge.py-1] [Drive 1] Controlword <- 0x000F
