...
# Drive 2 direction test: preserve the automatic-Home model pose
# q=[0,+pi/2,+pi/2,0] while reversing its count-to-radian sign.
...
group_csp_launch() {
  ...
  echo "Drive 2 方向校正：lowerarm_direction=$LOWERARM_DIRECTION，lowerarm_home_offset_counts=$LOWERARM_HOME_OFFSET_COUNTS"
