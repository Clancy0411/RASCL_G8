...
`home_offset_counts=[0,+802816,-802816,0]`; Drive 1 and Drive 2 each use a
paired mapping so positive ROS commands match physical motion. Final values must be replaced by raw
