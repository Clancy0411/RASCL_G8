...
map the switch pose to the URDF angles above. Drive 1 and Drive 2 each use a
paired direction/offset mapping so positive ROS commands match physical motion.
The conversion is:
