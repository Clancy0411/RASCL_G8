...
`homing_offsets=[0,0,0,0]` 是驱动器 `0x607C`，不得用来补偿 URDF 零位。Drive 1
使用 `direction=-1` 与 `home_offset_counts=+802816`，Drive 2 使用
`direction=+1` 与 `home_offset_counts=-802816`；两组配对均使正向规划对应实机正向，
