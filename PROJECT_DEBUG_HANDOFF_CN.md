...
`(0.1812,-0.0336,0.10) → (0.1812,-0.0336,0.045)`；当 `r < 0.17` 时走
`(0.1517,-0.0282,0.10) → (0.1517,-0.0282,0.045)`；当 `r > 0.20` 时走
`(0.2107,-0.0391,0.10) → (0.2107,-0.0391,0.045)`。后两条路径随后均到
`(0.1812,-0.0336,0.045)`；最后共同执行 `open →
(0.1812,-0.0336,0.10)`，不插入等待或确认。
