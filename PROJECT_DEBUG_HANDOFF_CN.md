...
Task 2 在 CSP 后由 T3 的组 `29` 执行。它只询问起点 `x/y`，随后按全部 `5 s` 的
连续动作完成 `(x,y,0.10) → (x,y,0.045) → close → (x,y,0.10)`，再到
`(0.18128633,-0.03369372,0.10) → (0.18128633,-0.03369372,0.045) → open →
